...
(function(){
    ...
    var bilibiliMove = document.getElementById('bilibili_a')
    ...
    function movebilibili(){
        if(w_num <= 400){
            // bilibiliMove.css({"left":x_arr[w_num]+"px","top":y_arr[w_num]});
            bilibiliMove.style.left = x_arr[w_num] + 'px';
            bilibiliMove.style.top = y_arr[w_num] + 'px';
            w_num += 3;
        }
        else{
    ...
    movebilibili();
    var weiTimer=setInterval(movebilibili,1);
    moveblog();
